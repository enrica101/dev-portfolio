      ...
      <li>
        <a className="tooltip tooltip-right" href="#home" data-tip="Home">
          <svg
            ...
            className="feather feather-home text-slate-300"
          >
      ...
      <li>
        ...
        >
          <svg
            ...
            strokeLinecap="round"
            strokeLinejoin="round"
            className="feather feather-grid  text-slate-300"
          >
      ...
      <li>
        ...
        >
          <svg
            ...
            strokeLinecap="round"
            strokeLinejoin="round"
            className="feather feather-figma  text-slate-300"
          >
      ...
      <li>
        ...
        >
          <svg
            ...
            strokeLinecap="round"
            strokeLinejoin="round"
            className="feather feather-phone  text-slate-300"
          >
